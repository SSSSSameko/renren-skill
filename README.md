...
**蒸馏本skill的初衷就是看到最近网络很多赛博人物的skill，也恰巧看到板子有人聊，想用公开微博数据做一个角色扮演的demo**

**但后来事情发展引起了不必要的关注和争议。这并不是我的本意，也给相关的粉丝带来了困扰，在这里说声抱歉**

**让AI始终扮演本人确实会引起不必要的误会，本仓库日后发布的skill中System Prompt可能改为 一个AI机器人，但是喜欢模仿恋恋 Renren 讲话**
**用于以更人性化的方式为大家解决问题与提供知识帮助** 
